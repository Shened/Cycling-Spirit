        ...
        <div className="space-y-6 max-w-5xl mx-auto">
            ...
            <div className="animate-fade-up delay-100 bg-dark-800 border border-white/5 rounded-2xl p-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <div className="flex items-center gap-3 flex-wrap">
                                <h1 className="font-display text-2xl text-white tracking-wide">{tour.name.toUpperCase()}</h1>
                                <span className={cn("text-xs px-2 py-0.5 rounded-full border font-medium", status.color)}>{status.label}</span>
                            </div>
                            {tour.description && <p className="text-sm text-neutral-400 mt-1">{tour.description}</p>}
                    ...
                    {leader && (
                        <div className="flex items-center gap-2 bg-yellow-500/10 border border-yellow-500/20 rounded-xl px-3 py-2">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-white font-semibold">{leader.name}</p>
                            </div>
                        </div>
                    )}
                </div>
                ...
                {myParticipation?.status === "pending" && (
                    <div className="mt-4 p-3 bg-brand-500/10 border border-brand-500/20 rounded-xl flex items-center justify-between gap-4">
                                ...
                                <div key={stage.id} className="bg-dark-800 border border-white/5 rounded-2xl overflow-hidden">
                                    ...
                                    <div className="flex items-center justify-between px-5 py-4 border-b border-white/5">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="font-semibold text-white">Etapa {stage.number} — {stage.name}</p>
                                                <div className="flex items-center gap-3 text-xs text-neutral-500 mt-0.5">
                                                    <span>{format(parseISO(stage.date), "d 'de' MMMM yyyy", { locale: pt })}</span>
                                        ...
                                        {isOrganiser && (
                                            <div className="flex items-center gap-2">
                                                <button
                                                    onClick={() => { setShowAddSpecial(stage); setSpecialForm({ name: "", type: "sprint", km: "", stravaSegmentId: "", results: [] }); }}
                                                ...
                                                >
                                                    <Edit3 className="w-3 h-3" /> Resultados
                                                </button>
                                            </div>
                                        )}
                                    </div>
                                            ...
                                            {stage.results
                                                ...
                                                .map((r, idx) => (
                                                    <div key={r.id} className="flex items-center gap-3">
                                                        <span className={cn("w-5 text-center text-xs font-bold",
